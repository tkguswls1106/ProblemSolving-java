...
public class DP_BOJ_9095 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // - 점화식 찾기 :
        // 4는 3+'1', 2+'2', 1+'1'로 나타낼 수 있음.
        // 4 = ? + 단순숫자1 = (4-1) + 단순숫자1 = (1,2,3의 합으로 만들수있는 3의 가짓수) + 단순숫자1
        // 4 = ? + 단순숫자2 = (4-2) + 단순숫자2 = (1,2,3의 합으로 만들수있는 2의 가짓수) + 단순숫자2
        // 4 = ? + 단순숫자3 = (4-3) + 단순숫자3 = (1,2,3의 합으로 만들수있는 1의 가짓수) + 단순숫자3
